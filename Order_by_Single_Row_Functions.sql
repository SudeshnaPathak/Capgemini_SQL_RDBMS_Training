...
SELECT * FROM EMP WHERE initcap(ENAME) = 'Allen'; -- ONLY FOR Oracle
...
-- 7. SUBSTR(String , pos , no of characters) : In SQL indexing starts from 1
SELECT SUBSTR('MALAYALAM' , 1 , 4) FROM DUAL; -- MALA
SELECT SUBSTR('MALAYALAM' , 5 , 1) FROM DUAL; -- Y
SELECT SUBSTR('MALAYALAM' , 5 , 2) FROM DUAL; -- YA
SELECT SUBSTR('MALAYALAM' , 7) FROM DUAL; -- LAM
SELECT SUBSTR('MALAYALAM' , LENGTH('MALAYALAM')) FROM DUAL; --M
SELECT SUBSTR('MALAYALAM' , LENGTH('MALAYALAM')-1) FROM DUAL; -- AM
SELECT SUBSTR('MALAYALAM' , -2) FROM DUAL; -- AM
SELECT SUBSTR('MALAYALAM' , -2 , 1) FROM DUAL; -- A
SELECT SUBSTR('MALAYALAM' , -2 , 3) FROM DUAL; -- AM
SELECT SUBSTR('MALAYALAM' , -4 , 2) FROM DUAL; -- AL

SELECT SUBSTR(ENAME , 1 , 2) , ENAME FROM EMP; -- FIRST 2 CHARACTERS
SELECT SUBSTR(ENAME , 2 , 1) , ENAME FROM EMP; -- 2ND CHARACTER
SELECT SUBSTR(ENAME , -1) , ENAME FROM EMP; -- LAST CHARACTER
SELECT ENAME FROM EMP WHERE SUBSTR(ENAME , 1 , 1) IN ('A' , 'S'); -- NAMES STARTING WITH A OR S

-- 8.REPLACE()
SELECT REPLACE('MALAYALAM' , 'A' , 'Z') FROM DUAL; -- MZLZYLZM
SELECT REPLACE('MALAYALAM' , 'A' , '') FROM DUAL; -- MLYLM
